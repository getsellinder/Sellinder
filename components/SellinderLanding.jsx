...
export default function SellinderLanding() {
  ...
  const features = [
    {
      ...
      desc: [
        "Will they likely be interested?",
        "Reasoning behind the prediction",
        "Confidence score and signals",
      ],
      icon: "🔮",
    },
    {
      ...
      desc: [
        "What they like and engage with",
        "Topics to open the conversation",
        "Tone and communication cues",
      ],
      icon: "💡",
    },
    {
    ...
    },
    {
      ...
      desc: [
        "Likely objections to expect",
        "Suggested responses and reframes",
        "Short ROI-focused rebuttals",
      ],
      icon: "🛡️",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Sellinder gave me the confidence to walk into meetings already knowing what would click with my prospects.",
      name: "Rohit Sharma",
      role: "Head of Sales, Acme Corp",
    },
    {
      quote:
        "Our conversion rate improved in 6 weeks — Sellinder made our outreach smarter and far more personal.",
      name: "Priya Menon",
      role: "Revenue Ops, Stellar SAAS",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            <div className="md:flex md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-slate-600">
                  Cold outreach, uncertain meetings, and lost opportunities
                  because you didn't know what would resonate.
                </p>
              </div>

              <div className="mt-4 md:mt-0">
                <h3 className="text-xl font-semibold">
                  The new way: Sellinder
                </h3>
                <p className="mt-2 text-slate-600">
                  Walk into meetings prepared — with clear insights, suggested
                  talking points, and objection responses.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="value" className="mt-12">
            <h3 className="text-xl font-bold">
              Why Sales Teams Love Sellinder
            </h3>
            <ul className="mt-4 grid sm:grid-cols-2 gap-4">
              <li className="p-4 border rounded-lg">
                Get an unprecedented peek into your buyer's mind
              </li>
              <li className="p-4 border rounded-lg">
                Walk in with confidence, not guesswork
              </li>
              <li className="p-4 border rounded-lg">
                Boost conversions with smarter conversations
              </li>
              <li className="p-4 border rounded-lg">
                Empower your entire revenue team to close faster
              </li>
            </ul>
          </section>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-slate-600">
                  ...
                  Growth Plan is our{" "}
                  <span className="font-semibold">Most Popular</span> choice —
            ...
            <div className="mt-6 grid gap-6 grid-cols-1 md:grid-cols-4">
              ...
              <div className="p-6 border rounded-2xl text-center">
                ...
                <div className="mt-3 text-sm text-slate-600 text-left">
                  <div>
                    • {yearly ? "24 searches / year" : "2 searches / month"}
                  </div>
                  <div>• 1 user</div>
          ...
          >
            <h3 className="text-xl font-bold">
              🔌 Install the Sellinder Chrome Extension
            </h3>
            <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
              To unlock the full power of Sellinder, install our official Google
              Chrome extension. It seamlessly integrates with LinkedIn, analyzes
              profiles in real-time, and generates your buyer intelligence
              report directly inside your workflow.
            </p>
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 bg-orange-500 text-white px-6 py-3 rounded-2xl font-semibold shadow hover:opacity-95"
              >
          ...
          <section id="users" className="mt-12">
            ...
            <div className="mt-4 flex gap-4 flex-wrap">
              <div className="p-4 border rounded-lg min-w-[180px]">
                Sales Professionals
              </div>
              <div className="p-4 border rounded-lg min-w-[180px]">
                Revenue Teams
