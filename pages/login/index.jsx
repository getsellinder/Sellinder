...
const Login = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const possibleUser = data?.user || data?.data?.user || data?.userData || data?.data || data;
      ...
      let finalUser = null;
      if (possibleUser && typeof possibleUser === 'object' && (possibleUser.email || possibleUser.name || possibleUser.id)) {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg text-sm ${errors.password ? 'border-red-300 focus:ring-red-200' : 'border-gray-300 focus:ring-orange-200'
                      } focus:outline-none focus:ring-2`}
